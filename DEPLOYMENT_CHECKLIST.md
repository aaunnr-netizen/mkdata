...
Fast reference checklist to deploy **MK Data** on Vercel in 15 minutes.
...
□ NEXT_PUBLIC_APP_URL = https://mkdata.vercel.app
```
...
3. Click generated URL (e.g., `https://mkdata.vercel.app`)
...
4. Paste: https://github.com/aaunnr-netizen/mkdata.git
5. Click: "Import"
...
- [ ] **URL Loads** → `https://mkdata.vercel.app`
