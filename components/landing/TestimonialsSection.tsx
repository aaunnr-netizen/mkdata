...
const testimonials = [
  {
    ...
    quote:
      "I've tried so many data platforms, but MK DATA is on another level. Instant delivery, best prices, and the PIN security is genius. Highly recommended!",
    rating: 5,
  },
  {
    name: "Tunde Okonkwo",
  ...
  },
  {
    ...
    quote:
      "Finally, a platform that doesn't play games with data pricing. I save money every month using MK DATA. The dedicated account number is a game changer.",
    rating: 5,
  },
];
