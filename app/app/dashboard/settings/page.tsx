    ...
    <div className="min-h-screen bg-[var(--app-bg,#0A0F0E)] text-white">
      ...
      <div className="p-4 space-y-6 pb-8">
        ...
        <div className="mt-6 rounded-xl border border-white/10 bg-white/5 p-4 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <p className="text-xs text-white/80 font-semibold">Contact Developer</p>
          </div>
          <a
        ...
        <SheetContent side="bottom" className="bg-[var(--app-bg,#0A0F0E)] border-white/10 text-white max-h-96 overflow-y-auto">
          ...
          <div className="text-sm text-white/70 space-y-4">
            <p>
              ...
              <br />
              By using MK DATA, you agree to these Terms of Service and all applicable laws and regulations.
            </p>
            <p>
            ...
            <p>
              ...
              <br />
              The materials on MK DATA are provided without warranties of any kind, either expressed or implied.
            </p>
            <p>
              <strong>4. Limitation of Liability</strong>
              <br />
              In no case shall MK DATA or its suppliers be liable for any damages resulting from use or inability to use the materials.
            </p>
            <p>
              <strong>5. Accuracy of Materials</strong>
              <br />
              The materials appearing on MK DATA could include technical, typographical, or photographic errors. We do not warrant that any materials are accurate, complete, or current.
            </p>
          </div>
        </SheetContent>
      </Sheet>
