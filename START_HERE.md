...
3. Paste: https://github.com/aaunnr-netizen/mkdata.git
4. Click: "Import"
```
...
| 12 | `NEXT_PUBLIC_APP_URL` | Your domain | `https://mkdata.vercel.app` |
...
```
https://github.com/aaunnr-netizen/mkdata
```
...
2. Go to vercel.com
          ↓
3. Connect GitHub repo (aaunnr-netizen/mkdata)
          ↓
...
6. Wait 2-5 minutes for build
          ↓
7. Get live URL: https://mkdata.vercel.app
          ↓
8. Test all features
          ↓
9. LIVE! 🎉
...
**Repository:** https://github.com/aaunnr-netizen/mkdata
