...
Complete step-by-step guide to deploy **MK Data** on Vercel with full environment setup.
...
- [ ] GitHub account with access to [mkdata repository](https://github.com/aaunnr-netizen/mkdata)
...
2. Under "Import Git Repository", paste:
   ```
   https://github.com/aaunnr-netizen/mkdata.git
   ```
3. Click **"Continue"**
4. Select repository owner: `aaunnr-netizen`
5. Click **"Import"**
...
1. **Go to Project Dashboard:**
   ```
   https://vercel.com/dashboard/aaunnr-netizen/mkdata
   ```
...
- **Preview URL:** `https://[branch-name]--mkdata.vercel.app` (auto-updated on commits)
- **Production URL:** `https://mkdata.vercel.app` (main branch)
...
- [ ] App loads without errors (`https://mkdata.vercel.app`)
