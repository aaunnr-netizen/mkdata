...
This guide explains every environment variable needed for **MK Data** application deployment on Vercel and local development.
...
curl -H "X-Admin-Password: your_admin_password" \
  https://mkdata.vercel.app/api/admin/users
```
...
Staging:      https://staging.mkdata.com
Production:   https://mkdata.com
```

**Important:**
- **Development:** `http://localhost:3000`
- **Vercel Preview:** Auto-generated (usually `https://branch--reponame.vercel.app`)
- **Production:** Your actual domain (e.g., `https://mkdata.com`)
...
2. **Select Project:** Click on `mkdata`
...
| `NEXT_PUBLIC_APP_URL` | ✅ | All | URL | https://mkdata.com |
...
# Visit your app: https://mkdata.com
