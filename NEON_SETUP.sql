-- ====================================================================
-- MK DATA - Complete Database Schema & Seed Script
-- For Neon PostgreSQL
...
VALUES
  (gen_random_uuid()::TEXT, 'MK Data Admin', '09066120642', '$2b$12$puQ4dKDdzL7dDeakd7MDROIC7I.5EItLV0iz9p7kYga.aa4S.ezY', 'admin@mkdata.local', 'ADMIN', 0, FALSE, TRUE);
